...
/* The mutation is in the food(a_burger) rule. It is an logial mutation. A negation(\+) was added before the second fact. To test-awnser no to the second a_burger question!*/
